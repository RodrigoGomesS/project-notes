    ...
    <div class="container mx-auto mt-10 px-4">
        <div class="flex flex-col items-center">
            ...
            <div class="w-full mt-6">
                <p class="text-3xl font-semibold text-gray-900 dark:text-gray-100">EDIT NOTE</p>
            </div>

            <form action="{{ route('editSubmit') }}" method="post" class="w-full mt-6">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="text_note" rows="5"
                        class="w-full px-3 py-2 bg-white shadow rounded-lg dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500">{{ old('text_note', $note->text) }}</textarea>
                    @error('text_note')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                <div class="flex justify-end space-x-3 mt-6">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-regular fa-circle-check mr-2"></i>Update
                    </button>
                </div>
            </form>
